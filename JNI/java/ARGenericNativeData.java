...
/**
 * Default implementation of the <code>ARNativeData</code> interface<br>
 */
public class ARGenericNativeData implements ARNativeData {
     ...
     * This constructor allocate a <code>ARGenericNativeData</code> with the given capacity
     * @param size Initial capacity of the <code>ARGenericNativeData</code>
     */
    public ARGenericNativeData (int size) {
     ...
     * This constructor allocate a <code>ARGenericNativeData</code> with the default capacity
     */
    public ARGenericNativeData () {
        this (DEFAULT_SIZE);
    }

    /**
     * Copy constructor<br>
     * This constructor creates a new <code>ARGenericNativeData</code> with a capacity<br>
     * equal to the original objects data size
     * @param data The original <code>ARNativeData</code> to copy
     */
    public ARGenericNativeData (ARNativeData data) {
     ...
     * object data size
     * @param data The original <code>ARNativeData</code> to copy
     * @param capacity The minimum capacity in bytes for this <code>ARGenericNativeData</code>
     */
    public ARGenericNativeData (ARNativeData data, int capacity) {
    ...
    /**
     * Sets the used size of the <code>ARGenericNativeData</code>
     * @param size New used size of the command
     * @return <code>true</code> if the size was set
     * @return <code>false</code> if the size was invalid (bigger than capacity) or if the <code>ARGenericNativeData</code> is invalid
     */
    ...
    /**
     * Gets the capacity of the <code>ARGenericNativeData</code><br>
     ...
     * This function allow Java code to access (but not modify) the content of the <code>ARGenericNativeData</code>
